...
This manual explains all features and operations of the Research Claw Web Console. It is organized in a "Goal -> Steps -> Done" format so you can get started quickly.
...
5. After the page loads, you will see the Research Claw console.

Done when:

- The left sidebar shows a blue robot icon and the "Research Claw" title.
...
This manual covers the core features and workflows of the Research Claw WebUI. If you run into issues:
